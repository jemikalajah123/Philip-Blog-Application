...
@section('content')
    ...
    <p>This is my first laravel application and i am super excited. It has a blogging feature, please do well to register
        <a class="btn btn-success btn-sm" href="/register" role="button">Register</a> and Let's blog about our life experiences as
        it relates to education, work, health and whatever you feel like sharing.</p>
